...
export type MerchantCategory =
  ...
  | "professional_services" | "automotive" | "convenience_fuel" | "retail"
  | "restaurants_bars_entertainment" | "hospitality" | "education" | "finance_banking"
  | "fitness_wellness" | "personal_services" | "sports_recreation"
...
export const MOCK_MERCHANTS: Merchant[] = [
  // ─── Restaurants ────────────────────────────────────────────────
  { id: "m-001", name: "Iron Oak Restaurant",   category: "restaurants_bars_entertainment", address: "1100 Congress Ave",      lat: 30.2706, lng: -97.7428, phone: "+15125550101", email: "manager@ironoak.com",     employeeCountRange: "11-50",   status: "prospect",  lastActivity: daysAgo(3),   note: "Chef Romano runs the front of house. Lunch rush 11:30-1:30." },
  { id: "m-002", name: "Sunrise Cafe",          category: "restaurants_bars_entertainment", address: "401 W 2nd St",            lat: 30.2655, lng: -97.7475, phone: "+15125550102", email: "hello@sunrisecafe.com",   employeeCountRange: "1-10",    status: "active",    lastActivity: daysAgo(1),   note: "Owner Carlos asked for a proposal Tuesday." },
  { id: "m-003", name: "Joe's Pizza",           category: "restaurants_bars_entertainment", address: "612 E 6th St",            lat: 30.2667, lng: -97.7363, phone: "+15125550103",                                  employeeCountRange: "1-10",    status: "prospect",  lastActivity: daysAgo(5) },
  { id: "m-004", name: "Maple Bakery",          category: "restaurants_bars_entertainment", address: "208 W Mary St",           lat: 30.2483, lng: -97.7530, phone: "+15125550104", email: "eli@maplebakery.com",     employeeCountRange: "1-10",    status: "prospect",  lastActivity: daysAgo(4) },
  { id: "m-005", name: "Hilltop Pizzeria",      category: "restaurants_bars_entertainment", address: "2715 Manor Rd",           lat: 30.2900, lng: -97.7140, phone: "+15125550105",                                  employeeCountRange: "1-10",    status: "won",       lastActivity: daysAgo(12),  note: "Closed last quarter. Ask about a partner intro." },
  { id: "m-006", name: "Downtown Diner",        category: "restaurants_bars_entertainment", address: "318 Colorado St",         lat: 30.2667, lng: -97.7457, phone: "+15125550106",                                  employeeCountRange: "1-10",    status: "untouched", lastActivity: null },
  { id: "m-007", name: "Harbor Coffee",         category: "restaurants_bars_entertainment", address: "1810 W 6th St",           lat: 30.2724, lng: -97.7600, phone: "+15125550107",                                  employeeCountRange: "1-10",    status: "prospect",  lastActivity: daysAgo(2) },
...
export const CATEGORY_LABEL: Record<MerchantCategory, string> = {
  ...
  retail: "Retail",
  restaurants_bars_entertainment: "Restaurants, Bars & Entertainment",
...
const RETIRED_CATEGORY_LABEL: Record<string, string> = {
  ...
  food_beverage: "Restaurants, Bars & Entertainment",
  entertainment: "Restaurants, Bars & Entertainment",
};
