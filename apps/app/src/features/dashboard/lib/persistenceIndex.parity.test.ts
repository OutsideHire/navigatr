...
/** Minimal deal fixture; app + port only read id/owner_id/stage. */
function deal(id: string, ownerId: string | null, stage: Deal["stage"]): ScoreDeal {
  return { id, owner_id: ownerId, stage };
}
