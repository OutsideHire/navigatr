...
export const DEFAULT_ICP_CONFIG: IcpConfig = {
  ...
  consumerOnlyTypes: [
    ...
    // Feb 2026 Places-taxonomy exclusions (Table A, column B, exact API values).
    // Non-SMB-prospect place types across automotive, business, culture,
    // education, recreation, facilities, finance, geographic areas, government,
    // housing, lodging, natural features, worship, services, shopping, sports,
    // and transportation. NOTE: `lodging` is included per column B, which also
    // removes hotels/motels (they carry the "lodging" type), reversing the
    // earlier §6.1 keep-hotels decision.
    "academic_department",
    "accounting",
