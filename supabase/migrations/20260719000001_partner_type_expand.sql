...
begin
  ...
  ('b0000000-0000-0000-0000-000000000001', v_org_id, v_owner, 'Jane Whitfield', 'Whitfield & Associates CPA', 'cpa_bookkeeper', 'active', '+14155550201', 'jane@whitfieldcpa.example.com', 'Cedar Ridge', now() - interval '9 days'),
  ('b0000000-0000-0000-0000-000000000002', v_org_id, v_owner, 'Derek Osei', 'First Cedar Bank', 'business_banker_commercial_lender', 'active', '+14155550202', 'derek@firstcedarbank.example.com', 'Fairhaven', now() - interval '11 days'),
  ('b0000000-0000-0000-0000-000000000003', v_org_id, v_owner, 'Monica Ferreira', 'Ferreira Law Group', 'small_business_attorney', 'active', '+14155550203', 'monica@ferreiralaw.example.com', 'Cedar Ridge', now() - interval '60 days');
